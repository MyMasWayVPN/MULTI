...
adminip=$( curl -sS https://raw.githubusercontent.com/MyMasWayVPN/MyMasWayVPN.github.io/main/wkwkwkwk | grep $MYIP )
...
setadmin() {
#isi link git
linkinstall="https://github.com/MyMasWayVPN/MyMasWayVPN.github.io/main"
rm -rf /etc/adminip/
mkdir -p /etc/adminip
read -p "Masukan Token Code Github Anda : " ans
echo -e "$ans" >> /etc/adminip/access.conf
wget -O /usr/bin/wkwkwkwk ${linkinstall}/wkwkwkwk && chmod +x /usr/bin/wkwkwkwk
clear
...
sleep 1
cek=$( curl -sS https://raw.githubusercontent.com/MyMasWayVPN/MyMasWayVPN.github.io/main/wkwkwkwk | awk '{print $5}' | grep $daftar )
if [[ $daftar = $cek ]]; then
...
rm -rf /root/allow
git config --global user.email "khoirul120604@gmail.com"
git config --global user.name "MyMasWayVPN"
git clone https://github.com/MyMasWayVPN/MyMasWayVPN.github.io.git
mkdir /root/allow
cd /root/allow/
rm -rf .git
git init
...
git branch -M main
git remote add origin https://github.com/MyMasWayVPN/MyMasWayVPN.github.iow.git
git push -f https://${tokengit}@github.com/MyMasWayVPN/MyMasWayVPN.github.io.git
...
git config --global user.email "khoirul120604@gmail.com"
git config --global user.name "MyMasWayVPN"
git clone https://github.com/MyMasWayVPN/MyMasWayBPN.github.io.git
cd /root/allow/
rm -rf .git
git init
touch ipvps.conf
