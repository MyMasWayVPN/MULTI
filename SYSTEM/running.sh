...
echo -e "$NC"
rm -f /usr/bin/user
export username=$( curl -sS https://raw.githubusercontent.com/${GitUser}/MyMasWayVPN.github.io/main/wkwkwkwk | grep $MYIP | awk '{print $2}' )
echo "$username" > /usr/bin/user

# // ORDER ID
rm -f /usr/bin/ver
export user=$( curl -sS https://raw.githubusercontent.com/${GitUser}/MyMasWayVPN.github.io/main/wkwkwkwk | grep $MYIP | awk '{print $3}' )
echo "$user" > /usr/bin/ver

# // VALIDITY
rm -f /usr/bin/e
export valid=$( curl -sS https://raw.githubusercontent.com/${GitUser}/MyMasWayVPN.github.io/main/wkwkwkwk | grep $MYIP | awk '{print $4}' )
