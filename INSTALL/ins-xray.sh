...
#xray-vless-xtls
                ...
                "fallbacks": [
                    ...
                    {
                        "path": "/mw-vlesswstls", # // VMESS WS TLS
                        "dest": 1212,
                        "xver": 1
                    },
                    {
                        "path": "/mw-vmesswstls", # // VLESS WS TLS
                        "dest": 1213,
                        "xver": 1
                    },
                    {
                        "path": "/mw-trojanwstls", # // TROJAN WS TLS
                        "dest": 1214,
                        "xver": 1
                    }
                ]
  ...
  "inbounds": [
      ...
      "settings": {
        ...
        "fallbacks": [
          ...
          {
            "path": "/mw-vlesswsntls", # // VLESS NONE
            "dest": 1301,
            "xver": 1
          },
          {
            "path": "/mw-vmesswsntls", # // VMESS NONE
            "dest": 1302,
            "xver": 1
          },
          {
             "path": "/mw-trojanwsntls", # // TROJAN NONE
            "dest": 1303,
            "xver": 1
          }
        ]
