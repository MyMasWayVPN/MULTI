...
VALIDITY () {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/${GitUser}/MyMasWayVPN.github.io/main/wkwkwkwk | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://raw.githubusercontent.com/${GitUser}/MyMasWayVPN.github.io/main/wkwkwkwk | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
function defaultv () {
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/main/MENU/banner/bannersshDefault.conf && chmod +x /etc/issue.net
...
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/main/MENU/banner/bannerssh1.conf && chmod +x /etc/issue.net
...
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/main/MENU/banner/bannerssh2.conf && chmod +x /etc/issue.net
...
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/main/MENU/banner/bannerssh3.conf && chmod +x /etc/issue.net
...
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/main/MENU/banner/bannerssh4.conf && chmod +x /etc/issue.net
